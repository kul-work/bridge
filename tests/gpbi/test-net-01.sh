...
DUMMY_TOKEN="mock-google-play-subscription:$PRODUCT_ID:test-net-01-token-$TEST_RUN_ID"
...
PURCHASE_TOKEN="mock-google-play-subscription:$PRODUCT_ID:test-net-01-webhook-first-$(date +%s)"
