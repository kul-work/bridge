...
TEST_RUN_ID="net-02-${TIMESTAMP}-$$"
PRODUCT_ID="$PRODUCT_ID_SUB"
PROVIDER="$PROVIDER"
REPORT_FILE="net-02-report.json"
USER_ID="${USER_ID:-test_net_02_user_$TEST_RUN_ID}"
DUMMY_TOKEN="mock-google-play-subscription:$PRODUCT_ID:test-net-02-token-$TEST_RUN_ID"
WEBHOOK_ID="webhook-net-02-$TEST_RUN_ID"
...
PURCHASE_TOKEN="mock-google-play-subscription:$PRODUCT_ID:test-net-02-retry-$(date +%s)"
