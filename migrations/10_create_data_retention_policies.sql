...
-- Cleanup function for webhook_provider (90-day retention)
CREATE OR REPLACE FUNCTION cleanup_old_webhook_provider()
RETURNS void AS $$
BEGIN
    DELETE FROM webhook_provider
...
COMMENT ON FUNCTION cleanup_old_webhook_provider() IS 'Delete webhook_provider records older than 90 days. Call from background job daily.';
